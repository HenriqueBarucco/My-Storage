            ...
            <div className="flex flex-col w-screen h-auto pl-4">
                <div className='flex-grow'>
                    ...
                    <div className="flex items-end -mt-8">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className={`w-6 h-6 flex-shrink-0 ml-auto ${product.isAtBox ? 'stroke-primary' : 'stroke-current'}`}>
                ...
                <div className='flex flex-row justify-center space-x-4'>
                    ...
                    <button onClick={deleteProduct}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="w-6 h-6 stroke-red-600">
